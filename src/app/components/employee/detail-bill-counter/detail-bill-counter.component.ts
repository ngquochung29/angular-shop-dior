...
@Component({
  selector: 'app-detail-bill-counter',
  templateUrl: './detail-bill-counter.component.html',
  styleUrls: ['./detail-bill-counter.component.scss']
})
export class DetailBillCounterComponent implements OnInit {
orderId: number =0;
