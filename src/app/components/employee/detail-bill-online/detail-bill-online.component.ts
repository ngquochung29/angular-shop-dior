...
@Component({
  selector: 'app-detail-bill-online',
  templateUrl: './detail-bill-online.component.html',
  styleUrls: ['./detail-bill-online.component.scss']
})
export class DetailBillOnlineComponent implements OnInit {
